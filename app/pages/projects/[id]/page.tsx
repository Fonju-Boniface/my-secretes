...
type ProjectKeys = "generalTools" | "frontendTools" | "backendTools" | "researchTools" | "deploymentTools";
...
const ProjectDetails = () => {
  ...
  return (
    <div className="relative">
      <h1 className="text-xl sm:text-3xl md:text-5xl font-bold mb-4 mt-32">{project.projectName}</h1>
      {project.imageUrl && (
        <Image
