    ...
    return (
        <div className="p-6 grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card className="p-1">
                <CardHeader>
                    <CardTitle className="text-lg font-bold flex justify-start items-center gap-2">
                        <Image src="/locked-with-key.svg" alt="Profile Image" width={50} height={50} className=' rounded-full p-2 border-primary border' />
                        my name
                    </CardTitle>
                </CardHeader>
                <CardContent className="flex items-start justify-center flex-col" >
                    ...
                    <p className="text-sm">
                        <strong>Email:</strong> exam@gmail.com
                    </p>
                    <p className="text-sm">
                        <strong>UID:</strong> dsfkjdliuscjsdlcndsjc
                    </p>
                    <p className="text-sm">
                        <strong>Role:</strong> user
                    </p>
                    <p className="text-sm">
                        <strong>Sign-In Method:</strong> google
                    </p>
                    <p className="text-sm">
                        <strong>Account Created:</strong> Thu, 09 Jan 2025 12:12:49 GMT
                    </p>
                    <p className="text-sm">
                        <strong>Last Sign-In:</strong> Thu, 09 Jan 2025 12:12:49 GMT
                    </p>
                </CardContent>
                <CardFooter className="flex space-x-2">
