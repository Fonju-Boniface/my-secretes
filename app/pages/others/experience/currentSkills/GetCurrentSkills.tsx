          ...
          {skills.length === 0 ? (
            ...
            skills.map((skill) => (
              <div
                ...
                lg:border lg:bg-gray-200 lg:p-2 lg:dark:bg-zinc-800/30 p-1"
              >
                <div className="flex flex-col justify-start items-center ">
                  ...
                  <h2 className="text-xl font-bold mt-4 text-primary w-full">
                    {skill.title}
                  </h2>
                  <small className="text-sm sm:text-xs mt-1 w-full">
                    {skill.SkCategory}
                  </small>
                  <small className="text-sm sm:text-xs mt-1 w-full">
                  ...
                  <p className="text-sm sm:text-xs mt-1 w-full">
                    {skill.SkDescription}
                  </p>
                </div>
              </div>
