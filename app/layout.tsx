...
<Script
      ...
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased ${inter.className} w-[100%] flex justify-end items-end relative`}
      >
       <NextThemesProvider
          attribute="class"
          defaultTheme="dark"
